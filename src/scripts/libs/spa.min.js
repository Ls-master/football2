		...
		(function() {
			...
			function pt(e) {
				if(g.test(r.readyState) && r.body) {
					...
					xt(r, "DOMContentLoaded", function() {
						e()
					}, s)
				}
			}
			...
			var At = r.compareDocumentPosition ? function(e, t) {
			...
			pt(function() {
				var e = Pt(n);
				n.addEventListener(en, function() {
					var t = Pt(n);
				...
				W(h.prototype, {
					...
					launch: function(e, t) {
						...
						if(s) {
							...
							a = s.entity;
							if(n.curTag === e && u) {
								u.mergeParam(W({}, n.param, t));
								u.trigger("refresh")
							} else {
								if(n.renderAll) {
									a.mergeParam(W({}, n.param, t));
									if(u) {
									...
									a = s.entity = o;
									n.renderOneDefer = r(s.name, W({}, s.param, n.param, t), n).done(function(r) {
										if(r) {
											a = s.entity = r;
											a.mergeParam(W({}, n.param, t));
			...
			a("view", function() {
				...
				function m(e) {
					X(e.options.bindEvents, function(t, n) {
						if(F(n)) {
							e.on(t, n.bind(e))
						}
					})
				...
				function g(n) {
					e.onChange(function(e) {
						...
						switch(a) {
							...
							case "home":
								$(function() {
									t.backTo(r.view, u, r.query, function() {
										p.trigger(a)
									})
								}, 100);
								break
				...
				var w = W(p, {
					...
					open: function(n, r, o) {
						...
						if(u[1] && u[1].skipFilter || d.reduce(function(e, t) {
							...
							r = r || {};
							var a = r.param || {};
							t.add(n, r, !!r.atBottom, function(t) {
								if(t) {
									m(t);
									e.setHashInfo({
										view: t.name,
				...
				if(c.gesture) {
					if(c.gesture.open) {
						...
						if(c.gesture.autoBlur) {
							...
							xt(r.body, "touchstart", function(e) {
			...
			(function() {
				...
				var g = {},
					y = s;
				e.addPlugin("moveEnter", m, function(t, n, h) {
					var E = {
							position: "absolute",
							top: 0,
							zIndex: n.zIndex || G()
...
(function(e) {
	...
	var n = function(e, t, n) {
		(function() {
						...
						if(o = a.name.match(jt)) {
							...
							if(typeof M[f] === "function") {
								...
								if(f === "html" || f === "text") {
									var d = Zt(c);
									avalon.mix(p, d);
									p.filters = p.filters.replace(Kt, function() {
										p.type = "html";
										p.group = 1;
										return ""
									})
				...
				if(s.length) {
					for(var o = 0, i; i = s[o++];) {
						...
						if(i.expr) {
							i.type = "text";
							i.element = u;
							i.filters = i.filters.replace(Kt, function() {
								i.type = "html";
								i.group = 1;
								return ""
							});
			...
			function Hn(e, t) {
				t = t.replace(On, "").replace(Mn, function() {
					return "],|"
				}).replace(_n, function(e, t) {
					return "[" + mn(t)
				}).replace(Dn, function() {
					return '"],["'
				}).replace(Pn, function() {
			...
			var T = {};
			"Boolean Number String Function Array Date RegExp Object Error".replace(l, function(e) {
						...
						if(e && e.childNodes) {
							...
							for(var i = 0, s; s = r[i++];) {
								if(s.tagName) {
									...
									g.forEach.call(s.attributes, function(e) {
			...
			"sort,reverse".replace(l, function(e) {
				ht[e] = function() {
					var t = this.$model,
						n = t.slice(0),
						r = false;
			...
			Ct.th = Ct.td;
			String("circle,defs,ellipse,image,line,path,polygon,polyline,rect,symbol,text,use").replace(l, function(e) {
				Ct[e] = Ct.g
			});
			var kt = /<([\w:]+)/;
				...
				if(s.length) {
					for(var o = 0, u; u = s[o++];) {
						if(At[u.type]) {
							...
							g.forEach.call(u.attributes, function(e) {
			...
			var Kt = /\|\s*html\s*/,
				...
				Gt = /&lt;/g,
				Yt = /&gt;/g;
			"add,remove".replace(l, function(e) {
			...
			avalon.fn.mix({
				...
				data: function(e, t) {
					...
					switch(arguments.length) {
						...
						case 0:
							var r = {};
							g.forEach.call(this[0].attributes, function(t) {
								if(t) {
									e = t.name;
									if(!e.indexOf("data-")) {
										e = rn(e.slice(5));
			...
			"Width,Height".replace(l, function(e) {
				var t = e.toLowerCase(),
					n = "client" + e,
					r = "scroll" + e,
					i = "offset" + e;
			...
			"title,alt,src,value,css,include,href".replace(l, function(e) {
				M[e] = M.attr
			});
			...
			"hover,active".replace(l, function(e) {
				M[e] = M["class"]
			});
			...
			M.widget = function(e, n) {
				...
				if(typeof a === "function") {
					...
					var v = e[s + "Options"] = avalon.mix({}, a.defaults, h || {}, d);
			...
			"with,each".replace(l, function(e) {
				M[e] = M.repeat
			});
			var cr = [];
			var hr = [];
			...
			var Tr = avalon.filters = {
				...
				camelize: rn,
				sanitize: function(e) {
					return e.replace(yr, "").replace(wr, function(e, t) {
				...
				escape: function(e) {
					return String(e).replace(/&/g, "&amp;").replace(Sr, function(e) {
						var t = e.charCodeAt(0);
						var n = e.charCodeAt(1);
						return "&#" + ((t - 55296) * 1024 + (n - 56320) + 65536) + ";"
					}).replace(xr, function(e) {
		...
		(function() {
			...
			QApp.addWidget = function(t, n, r) {
				...
				avalon.ui["qapp-" + t] = function(r, s, o) {
					...
					u = o[l].getView();
					f = e.delay(function() {
						e.each(r.dataset, function(e, n) {
							if(!e.indexOf(t)) {
								var r = e.substring(t.length).replace(/\w/i, function(e) {
									return e.toLowerCase()
								});
								if(!r.indexOf("arg")) {
			...
			QApp.addPlugin(["avalon", "engine.avalon"], {}, function(s, f) {
				var l = t + n++,
					c, h = {},
					p = s.mergeParam;
				if(e.isFunction(f)) {
					...
					e.each(f, function(t, n) {
						if(e.isFunction(n)) {
							h[t] = avalon.define(l + "-" + t, function(e) {
								e.getView = function() {
									return s
								};
								n.call(s, e)
	...
	var n = function(e, t, n) {
		(function() {
			...
			(function() {
				...
				QApp.addPlugin(["actionSheet", "ui.actionSheet"], s, function(s, c, v) {
					var y = {
							position: "absolute",
							left: 0,
							width: "100%"
			...
			(function() {
				...
				QApp.addPlugin(["ui.dialog", "dialog"], e, function(e, r, s) {
					var u = i.width,
						l = i.height,
						c = false,
						v;
			...
			(function() {
				...
				QApp.addPlugin(["popup", "ui.popup"], a, function(i, s, v) {
					var y = false,
						b = false;
					if(!v.animate) {
						s.duration = 0
					...
					i.show = function(n, a) {
						...
						if(!y) {
							...
							if(i.isShow) {
								...
								i.once("rendered", function() {
									if(s.group) {
										r.add(s.group, "touchstart", function(e) {
											if(e.el !== s.item) {
												b = true
											}
										})
									}
									i.root.addEventListener("tap", function(e) {
		...
		(function() {
			...
			function s(e) {
				...
				return t ? {
					...
					remove: function() {
						return t.removeItem ? function(e) {
			...
			p.extend(v.prototype, {
				...
				set: function(e, t) {
					if(p.isArray(t)) {
						...
						this._source[e] = p.extend(true, {}, t)
					} else {
						this._source[e] = t
					}
	...
	var n = function(e, t, n) {
		...
		(function() {
			function o(o, u) {
				...
				c.scrollOpt = e.extend({}, n, c.scrollOpt);
			...
			if(e) {
				e.bindingHandlers.iscroll = function(r, l) {
					var c = r.element,
						h = r.value.match(/[^, ]+/g),
						p = l[0],
						d = e.mix({}, n, p.iscroll, c.dataset, h && h[1] ? p[h[1]] : null),
							...
							if(w) {
								...
								for(u = 0; u < C; u++) {
									if(u >= i) {
										...
										n[u].$watch("$all", function(t) {
											return function(n, r) {
												e[t][n] = r
											}
										}(u));
										e[u].$watch("$all", function(e) {
											return function(t, r) {
												n[e][t] = r
											}
										}(u))
									...
									dataFilter: function(t, r, i, u) {
										...
										if(C) {
											if(t === "add") {
												...
												o(n[a], s(e[u]));
												n[a].$watch("$all", function(t, n) {
													e[u][t] = n
												});
												e[u].$watch("$all", function(e, t) {
													n[a][e] = t
												})
											} else {
												e[u].$unwatch();
	...
	var r = function(exports, module, global) {
			...
			n.fn = {
				...
				css: function(e, r) {
					...
					if(M(e) == "string") {
						...
						for(t in e)
							if(!e[t] && e[t] !== 0) this.each(function() {
		...
		(function(e) {
			...
			e.fn.on = function(t, o, u, a, f) {
				...
				if(!s(o) && !i(a) && a !== false) a = u, u = o, o = n;
				if(i(u) || u === false) a = u, u = n;
				if(a === false) a = w;
